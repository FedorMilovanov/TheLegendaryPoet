...
**Бренд:** эмблема — безликая фигура в капюшоне с раскрытой книгой, анонимный
«легендарный поэт». Канонический вектор — `public/brand-emblem.svg`; интерактивный
компонент — `src/components/BrandMark.tsx`. Не возвращать старую монограмму `LP`,
не добавлять лицо, глаза, православную символику или конфессиональные ярлыки.
Полные правила и карта платформенных иконок: [`docs/BRAND_EMBLEM.md`](docs/BRAND_EMBLEM.md).
