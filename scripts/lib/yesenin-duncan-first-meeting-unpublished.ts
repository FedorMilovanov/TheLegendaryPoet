...
const companionSources: EssaySource[] = [
  ...
  ...theatricalSources,
  {
    ...
    year: 1999,
    note:
      'Официальный комментарий ФЭБ к ПСС, т. 7, кн. 1, с. 409, формулирует 3 октября осторожно — с оговоркой «видимо» — и ссылается на «Материалы к биографии», с. 110; это не синхронный протокол вечера.',
  },
  {
