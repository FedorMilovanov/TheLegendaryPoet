...
const componentFile='src/components/BrandMark.tsx',motionFile='src/components/brandMotionV18.ts',sourceFile='src/components/brandEmblemV18.svg',standaloneFile='public/brand-emblem.svg',microFile='public/brand-mark-micro.svg',maskFile='public/brand-emblem-mask.svg';
const component=read(componentFile),motion=read(motionFile),source=read(sourceFile),standalone=read(standaloneFile),micro=read(microFile),mask=read(maskFile);
