...
const mobileSpec = /(mobile-platforms|mobile-home-webkit|analytics-route|yesenin-part-one|articles-catalog|secondary-data-failure|hover-stability|brand-emblem|brand-reference-comparison|community-request-topology|reader-journeys|premium-reader-certification|poets-status|rating-urlstate|audio-completion|hall-production-route)\.spec\.mjs/;
