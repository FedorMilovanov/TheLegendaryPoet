...
const mobileSpec = /(mobile-platforms|mobile-home-webkit|yesenin-part-one|articles-catalog|hover-stability|brand-emblem|brand-reference-comparison|community-request-topology|reader-journeys|premium-reader-certification|poets-status|rating-urlstate)\.spec\.mjs/;
