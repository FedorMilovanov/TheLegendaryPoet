...
const yeseninArchivePublished = publishEssay(yeseninKutezhiVisual, {
  coverKind: 'reconstruction',
  coverCredit: 'THE LEGENDARY POET · редакционная реконструкция',
  sources: uniqueEssaySources([
...
const yeseninPartTwoSources: EssaySource[] = [
...
export const essays: readonly PublishedEssay[] = Object.freeze([
  lermontovRoadPublished,
  yeseninArchivePublished,
...
export function getAllEssays(): readonly PublishedEssay[] {
  return essays;
}

export function getEssayBySlug(slug: string): PublishedEssay | undefined {
