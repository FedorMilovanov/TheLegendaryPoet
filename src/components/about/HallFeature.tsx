...
/**
 * About-page entry point for the Hall of Poets.
 * The production route remains a neutral placeholder until the Hall v3
 * reference, spatial and visual gates approve a concrete architecture.
 */
        ...
        <div className="luxury-card relative overflow-hidden rounded-[2rem] border border-luxury-gold/25 bg-gradient-to-br from-[#0e0c07] to-[#050505] p-8 md:p-12">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h2 className="mb-4 font-serif text-3xl font-bold text-white md:text-4xl">
              {titleCase('Зал')} <span className="gold-gradient gold-glow-text">{titleCase('Поэтов')}</span>
            </h2>
            <p className="mb-8 text-base leading-relaxed text-luxury-gray-light md:text-lg">
              Мы заново проектируем иммерсивное пространство о русской поэзии: сначала
              проверяем музейную логику, масштаб, свет, экспозицию и маршрут, и только затем
              переносим утверждённое решение в браузер. Раздел пока остаётся лёгкой заглушкой.
            </p>
            <Link
              to="/hall"
