...
export default function HeroPoetWindow({ poet, index }: HeroPoetWindowProps) {
  ...
  const handlePointerMove = (event: ReactPointerEvent<HTMLDivElement>) => {
    ...
    const normalizedX = Math.max(-0.5, Math.min(0.5, (event.clientX - bounds.left) / bounds.width - 0.5));
    const normalizedY = Math.max(-0.5, Math.min(0.5, (event.clientY - bounds.top) / bounds.height - 0.5));
  ...
  return (
    <motion.div
      ...
      transition={prefersReducedMotion
        ? { duration: 0 }
        : { delay: 0.09 * index, duration: 0.72, ease: [0.16, 1, 0.3, 1] }}
    ...
    >
      ...
      >
        ...
        >
          <div
            data-hero-poet-window-glow
            className="hero-poet-window-glow pointer-events-none absolute -inset-[7px] rounded-t-[999px] border border-cyan-200/0 bg-[radial-gradient(circle_at_50%_18%,rgba(95,225,255,0.24),transparent_48%)] opacity-35 blur-xl transition-all duration-700 group-hover:border-cyan-200/20 group-hover:opacity-100 group-hover:blur-2xl group-focus-visible:border-cyan-200/20 group-focus-visible:opacity-100"
          />
          ...
          <div className="absolute inset-[1px] overflow-hidden rounded-t-[999px] bg-[#020811] shadow-[0_18px_42px_rgba(0,0,0,0.48),inset_0_0_0_1px_rgba(173,238,255,0.08)] transition-shadow duration-700 group-hover:shadow-[0_25px_58px_rgba(0,0,0,0.58),0_0_34px_rgba(38,187,255,0.24),inset_0_0_0_1px_rgba(180,241,255,0.22)] group-focus-visible:shadow-[0_25px_58px_rgba(0,0,0,0.58),0_0_34px_rgba(38,187,255,0.24),inset_0_0_0_1px_rgba(180,241,255,0.22)]">
            ...
            >
              <PoetImage
                ...
                className="hero-poet-window-image h-full w-full scale-[1.04] object-cover grayscale contrast-125 opacity-75 saturate-[0.68] transition-[filter,opacity,transform] duration-700 ease-out group-hover:scale-[1.095] group-hover:grayscale-[0.28] group-hover:opacity-95 group-hover:saturate-[0.88] group-focus-visible:scale-[1.095] group-focus-visible:grayscale-[0.28] group-focus-visible:opacity-95 group-focus-visible:saturate-[0.88]"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="hero-poet-window-halo pointer-events-none absolute left-1/2 top-[28%] h-24 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-200/25 opacity-0 blur-2xl transition-opacity duration-500 group-hover:opacity-100 group-focus-visible:opacity-100 sm:h-32 sm:w-32"
            />
            <div
              aria-hidden="true"
              className="hero-poet-window-shine pointer-events-none absolute -left-1/2 top-[-18%] h-[140%] w-[46%] rotate-[18deg] bg-gradient-to-r from-transparent via-white/18 to-transparent opacity-0 blur-[1px] transition-[transform,opacity] duration-700 ease-out group-hover:translate-x-[330%] group-hover:opacity-70 group-focus-visible:translate-x-[330%] group-focus-visible:opacity-70"
            />
            ...
            <div
              ...
              className="hero-poet-window-label pointer-events-none absolute inset-x-0 bottom-0 translate-y-2 px-2 pb-2 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 sm:px-3 sm:pb-3"
            >
