...
function TestimonyCard({ item }: { item: Testimony }) {
  return (
    <div className="theme-elevated-surface rounded-3xl border border-luxury-gold/10 p-6 transition-colors hover:border-luxury-gold/25 md:p-8">
      ...
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-luxury-gold/10 pt-4">
        <div>
          <span className="theme-text text-sm font-bold">{item.author}</span>
