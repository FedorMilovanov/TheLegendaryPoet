              ...
              <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18, duration: 0.7, ease: [0.16, 1, 0.3, 1] }} className="min-w-0">
                ...
                <div className="mt-8 sm:mt-10">
                  <div className="relative flex h-24 items-center gap-[2px] overflow-hidden rounded-[1.4rem] border border-white/10 bg-black/30 px-4 shadow-inner shadow-black/50 sm:h-28">
                    ...
                    <span aria-hidden="true" className="pointer-events-none absolute inset-1 rounded-[1.1rem] border-2 border-transparent opacity-0 transition peer-focus-visible:border-white/90 peer-focus-visible:opacity-100 peer-focus-visible:shadow-[0_0_0_2px_color-mix(in_srgb,var(--track-accent)_65%,transparent)]" />
                  </div>
                </div>
